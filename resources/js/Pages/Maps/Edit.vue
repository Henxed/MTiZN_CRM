        ...
        <form @submit.prevent="submit" class="border-t border-gray-200 dark:border-slate-700 py-6">
            ...
            <div class="mt-10 sm:mt-0">
                ...
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-slate-400">Количество учебных заведений в данном регионе.</p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white dark:bg-slate-800 sm:p-6">
                            ...
                            <text-input v-model="form.detdom" :error="errors.detdom" label="Детские дома, интернаты" type="number" placeholder="Оставьте пустым, если нет детский домов и интернатов" min="1"/>

        ...
        <div class="w-full max-w-screen-xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                <div class="bg-slate-600/10 dark:bg-slate-400/10 p-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 xl:flex gap-6 sm:gap-12 mt-3 dark:text-slate-400 p-5 pt-0 sm:p-0">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="text-sm break-all">{{ declOfNum(region.extra.ssuz, ['ССУЗ', 'ССУЗа', 'ССУЗов']) }}</div>
                        </div>
                        <div>
                ...
                <div class="bg-slate-600/10 dark:bg-slate-400/10 p-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 xl:flex gap-6 sm:gap-12 mt-3 dark:text-slate-400 p-5 pt-0 sm:p-0">
                        ...
                        <div>
                            ...
                            <div class="text-sm break-all">Уровень безработицы</div>
                        </div>
                        <div>
                ...
                <div class="bg-slate-600/10 dark:bg-slate-400/10 p-6 rounded-xl">
                    ...
                    <Link class="block text-slate-400 dark:text-slate-300" v-for="(item, index) in region.selsoviet" :key="item">
                        {{ index+1 }}. {{ item.name }}
                    </Link>
                </div>
            </div>
